...
func (o *GetAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/accounts/{account_id}] getAccount", response, response.Code())
	}
}
...
func (o *GetAccountOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/accounts/{account_id}][%d] getAccountOK %s", 200, payload)
}
