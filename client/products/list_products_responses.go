...
func (o *ListProductsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/products/] List Products", response, response.Code())
	}
}
...
type ListProductsOK struct {
	Payload *models.PaginatedProductsList
}
...
func (o *ListProductsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/products/][%d] listProductsOK %s", 200, payload)
}
...
func (o *ListProductsOK) GetPayload() *models.PaginatedProductsList {
	return o.Payload
}
...
func (o *ListProductsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.PaginatedProductsList)
